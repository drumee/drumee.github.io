---
id: 04-acl-permissions
title: Configuring ACL Permissions
slug: /product-guides/04-acl-permissions
sidebar_position: 4
...
- [ACL System Concepts](../technology/02-acl-system.md) — bitwise permission model and architecture overview
- [ACL Field Specification](../api-reference/acl-spec.md) — complete field reference for ACL JSON files
- [Creating a Service](./02-creating-service.md) — step-by-step guide to implementing a new backend service