...
- Change to name servers fo your domain to ns1.your.domain and ns2.your.domain
  Wait the change to take effects. Meanwhile, download the Docker Compose Template File from [here](https://github.com/drumee/documentation/blob/main/templates/docker/production-template.yml)

```console
cp production-template.yml docker-compose.yml
```

- Use your favorite IDE to change values in _docker-compose.yml_ accordingly to your setup.
- Save the changes.
